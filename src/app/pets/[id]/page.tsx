    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-6">
          <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-border flex items-center justify-center bg-secondary">
            {pet.photo ? (
              <img 
                src={pet.photo} 
                alt={`${pet.name}`} 
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-3 mb-3">
              <Badge variant="secondary" className="bg-happy-purple/20 text-happy-purple border-happy-purple/30 text-lg px-4 py-2">
          ...
          <Link href={`/pets/${pet.id}/edit`}>
            <Button size="lg" variant="outline" className="border-2 border-happy-blue text-happy-blue hover:bg-happy-blue hover:text-white transition-all duration-300">
          ...
          <Card className="bg-gradient-card border-0 shadow-xl">
            ...
            <CardContent className="space-y-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-happy-green mb-2">
              ...
              {recentExpenses.length === 0 ? (
                ...
                <div className="space-y-4">
                  {recentExpenses.map((expense) => (
                    <div key={expense.id} className="flex items-center justify-between p-4 bg-secondary/30 rounded-xl border border-border/30">
                      <div className="flex-1">
